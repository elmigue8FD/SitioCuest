...
$(document).ready(function(){
	...
	$.ajax({
			type: 'POST',
			url: 'http://localhost/5_Poryectos_Personales/SitioCuest/php/realizarPruebaBD.php',
			data: {idMateria:idMateria,idTema:idTema,idCuestionario:idCuestionario}
		}).done(function(msg){
		//alert( "Cambio Recibir Notifi: " +msg);
				$("#content_preguntas").html(msg);
				//$("#content_preguntas").append("<input disabled='disabled' type='text' value="+i+" size=5/>");
				for(i=0;i<5;i++){
...
<body>
	<div class="main">
            <div class="formularioInsertar">
                ...
                <form method="post"  name="InsertarPregunta" id="formulario" action="MostrarResultados.php">
