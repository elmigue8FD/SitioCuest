...
<body>
    <div class="main">
            ...
            <div class="formularioInsertar">
                ...
                <h1>Inseratar Materia</h1>
				<p>Materias que ya estas registradas
				<?php
				$bdhost="localhost";
                ...
                <form method="post" action="../php/insertarMateriaBD.php" name="InsertarMateria" id="formulario">
                <p>Nomrbe de la materia:
                <input type="text" placeholder="Escribe la Materia" name="NombreMateriaNueva" id="NombreMateriaNueva" size=20/></p>
