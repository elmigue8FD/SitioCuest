...
$(document).ready(function(){
	...
	$.ajax({
			type: 'POST',
			//url: 'http://localhost/SitioCuest/php/BuscarTemaBD.php',
                ...
                <form method="post"  name="InsertarPregunta" id="formulario" action="../php/insertarCuestionarioBD.php">
                    <table border="0" width="500">
                        ...
                        <tr>
                            ...
                            <td>
                            	<p>
                                    <select name='CuestionarioExistente' id='CuestionarioExistente'  >
                                    	<option> ---- </option>
                                    </select>
                                </p>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <p>
                                    <input type='text' name='NombreCuestionario' id='NombreCuestionario' placeholder='Nombre del Cuestionario' size=20/>
                                </p>
                            </td>
                        </tr>
                        <tr>
