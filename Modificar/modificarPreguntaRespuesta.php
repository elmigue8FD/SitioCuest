...
$(document).ready(function(e) {
	...
	$("#Cuestionario").html("<option value=''> ---- </option>");
	$.ajax({
			type: 'POST',
	...
	$.ajax({
			...
			//alert( "Cambio Recibir Notifi: " +msg);
				$("#Cuestionario").html(msg);
				});
	});
	
	//buscamos en los cuestionarios existentes con la MAteria y el tema seleccionados
	jQuery('#Cuestionario').change(function () {
	//alert("Entro al javascript y a la funcion");
	var idMateria= document.getElementById("Materia").value;
	var idCuestionario=document.getElementById("Cuestionario").value;
	var TipoForm="modificarPreRest";
	$.ajax({
			type: 'POST',
...
<div class="main">
            <div class="formularioInsertar">
                <h1>Mofidicar Pregunta / Respuesta</h1>
                <form method="post" action="../php/modificarPreguntaRespuestaBD.php" name="InsertarTema" id="formulario">
                <table border="1" width="500">
                            ...
                            <td>
                                <p>
                                    <?php
                                        ...
                                        echo"<option> ---- </option>";
                                       	while ($sentencia->fetch()) {echo"<option value='$idMateria'> $nombreMateria $idMateria</option>";}
                                        echo"</select>";
					...
					<tr>
                            ...
                            <td>
                                <p>
                                    <select id="Cuestionario" name="Cuestionario">
                                        <option> --- </option>
                                    </select>
                                </p>
                            </td>
					...
					<tr>
                            ...
                            <td>
                                    <select name='PregRespModificar' id='PregRespModificar'>
                                    	<option> ---- </option>
                                    </select>
                            </td>
                    </tr>
                 	<tr>
                		...
                		<td>
                            ...
                            <input type="text" name="NombrePreguntaModificar" placeholder="Escribe el Cuestionario" id="NombrePreguntaModificar" size=20/>
                            </p>
                		</td>
					</tr>
					<tr>
                		...
                		<td>
                            ...
                            <input type="text" name="NombreRespuestaModificar" placeholder="Escribe el Cuestionario" id="NombreRespuestaModificar" size=20/>
                            </p>
                		</td>
					</tr>
                	<tr>
