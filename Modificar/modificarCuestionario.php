...
<div class="main">
            <div class="formularioInsertar">
                ...
                <form method="post" action="../php/modificarCuestionarioBD.php" name="InsertarTema" id="formulario">
                <table border="1" width="500">
					...
					<tr>
                            <td>
                                <p>
                                    Cuestionario a Modificar
                                </p>
                            </td>
                            <td>
                                <p>
                                    <select id="CuestionarioExistente" name="CuestionarioExistente">
                                        <option> --- </option>
                                    </select>
                                </p>
                            </td>
                 	...
                 	<tr>
                		...
                		<td>
                            ...
                            <input type="text" name="NombreCuestModificar" placeholder="Escribe el Cuestionario" id="NombreCuestModificar" size=20/>
                            </p>
                		</td>
					</tr>
